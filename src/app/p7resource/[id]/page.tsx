...
const ResourceDetailsPage: React.FC = () => {
  ...
  return (
    <div className="flex justify-around mx-24 my-11">
      <div className=" float-left w-[70%]  px-10">
        ...
        <div>
          ...
          <p className=" text-sm text-left mt-4">{item.discription}</p>
        </div>
          ...
          <div className="absolute h-[400px]">
            <div className=" flex gap-3  mb-2 p-2">
              ...
              <div>
                ...
                <p className="text-green-600 mt-2">01/jan/2024 By gwen stacy</p>
              </div>
            </div>
            <div className="flex gap-3 mb-2 p-2">
              <div className="w-32 h-24 border-4 border-green-500">
