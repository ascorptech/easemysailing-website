          ...
          <div key={item.id} className="flex  bg-white p-4 flex-shrink-0  ">
            <div className="bg-white border rounded-lg py-4 px-2 shadow-md  w-auto ">
              <div className="flex justify-center mb-2">
                ...
                />
                <div className="absolute mt-[13.2rem]  ml-[-16rem] text-base h-6 w-24 bg-green-700 text-white font-semibold ">
                  <h3>{item.date}</h3>
                </div>
              </div>

              <div className="text-sm mb-2">
                <span className="text-black-500"> {item.title}</span>
              </div>
              <div className="text-gray-500 text-sm text-justify"> {item.discription} </div>
