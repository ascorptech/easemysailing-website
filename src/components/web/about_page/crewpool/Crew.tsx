...
const Crew = () => {
  return (
    <div className="flex flex-col md:flex-row justify-center items-center w-full px-2 lg:px-24 lg:mt-24 mb-5">
      {/* Text Section */}
      <div className="flex flex-col md:w-1/2 lg:w-[817px] px-2 m-1">
        ...
        <p className="text-justify text-[16px] md:text-base lg:text-[18px] leading-[28px] text-[#4E4E4E]">
