    ...
    <div className="w-full lg:w-[99.4%] mx-1 my-9">
      <div className="flex flex-col md:flex-row justify-center  gap-8 md:gap-10 mx-4 md:mx-7 lg:mx-[106px]">
        ...
        <div className="flex flex-col justify-center items-center text-center border-2 shadow-lg rounded-tl-[2rem] rounded-br-[2rem] w-full md:w-[400px] h-auto pt-12">
          <div className=" flex flex-col h-[30%] w-full justify-center items-center">
        ...
        <div className=" flex flex-col h-[30%] w-full justify-center items-center">
          ...
          {/* <p className="mt-2 text-[16px] md:text-base lg:text-[16px] leading-[28px] text-justify text-[#4E4E4E] px-4">
            ...
            Reducing the environmental impact and promoting greener initiatives
            <br /> <b className="font-extrabold">Community:</b>&nbsp;
            Fostering collaboration and understanding through diverse
            perspectives
          </p> */}
          <ul className="list-none mt-2 text-[16px] md:text-base lg:text-[16px] leading-[28px] text-justify text-[#4E4E4E] px-4">
            <li>
              <b className="font-extrabold">Transparency:{" "}</b>
