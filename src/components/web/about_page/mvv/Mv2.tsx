...
const Mv2 = () => {
  return (
    <div className="w-full lg:w-[99.4%] mx-1 my-9">
      <div className="flex flex-col md:flex-row justify-center items-center gap-8 md:gap-10 mx-4 md:mx-7 lg:mx-[106px]">
        {/* First div */}
        ...
        {/* Third div */}
        <div className="flex flex-col justify-center items-center text-center border-2 shadow-lg rounded-tl-[3rem] rounded-br-[3rem] w-full md:w-[400px] h-[496px] pt-12">
          <Image
            src="/sqr.png"
            alt="Left Image"
            width={5000}
