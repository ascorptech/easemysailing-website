...
const Card = () => {
  ...
  return (
    <div className=" lg:ml-[4rem] ml-[2rem] relative flex items-center my-4 justify-center w-[1362px] h-[261px]">
      ...
      <div
        ref={card}
        className="flex overflow-x-scroll no-scrollbar scroll-smooth snap-x snap-mandatory mx-[6.5rem] w-[1277px] h-[261px] gap-10  text-center"
      >
        {/* Card 1 */}
        {cards.map((card) => (
