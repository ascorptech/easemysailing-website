...
const Signup = () => {
  ...
  return (
    <div className="flex flex-col  lg:flex-row items-center justify-center xl:justify-between  gap-5 bg-gray-100 border-2 border-grey sm:w-full sm:m-0 sm-p-0 ml-4  w-full m-0 mt-2">
      ...
      <div className="w-full lg:w-[33%] text-center px-4 lg:px-0">
        ...
        <div className="mb-4 flex justify-evenly items-center">
          <button
            type="button"
            className="text-black bg-white border border-green-800 hover:bg-green-600 focus:ring-1 focus:outline-none focus:ring-green-800 font-medium rounded-lg text-sm px-5 py-2.5 inline-flex items-center mb-2 w-full lg:w-auto"
          >
            <Image
              src="/google.png"
              alt="Google Logo"
          ...
          <button
            type="button"
            className="text-black bg-white hover:bg-green-600 focus:ring-1 focus:outline-none focus:ring-green-800 font-medium border border-green-800 rounded-lg text-sm px-5 py-2.5 inline-flex items-center mb-2 w-full lg:w-auto"
          >
            <Image
              src="/facebook.png"
              alt="Facebook Logo"
        ...
        <div className="p-2">
          ...
          >
            ...
            <button
              type="submit"
              className="w-full lg:w-[40%] bg-green-700 text-white rounded-lg hover:bg-green-800 py-2 px-4 text-center"
              style={{ minHeight: "2.5rem" }} // Ensures consistent height
            >
              Continue with Email
            </button>
