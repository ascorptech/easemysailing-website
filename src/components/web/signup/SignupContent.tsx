      ...
      <div className="relative bg-black bg-opacity-50 mt-16 w-full h-screen z-5 flex items-center justify-center text-center text-white">
        <div className="p-3 flex flex-col items-center justify-center rounded-md w-[90%] sm:w-[80%] md:w-[70%]">
          ...
          <div className="flex flex-col sm:flex-row text-center justify-center items-center gap-4 sm:gap-6 lg:gap-12 mt-10 lg:mt-14">
            <Link
              href="#"
              className="bg-[#00A264] px-4 py-2 lg:px-2 lg:h-[50px] rounded-full font-semibold text-base w-[160px]"
            >
              Login
            </Link>
            ...
            <Link
              href="#"
              className="bg-white px-4 py-2 lg:px-2 lg:h-[50px] rounded-full font-semibold text-base w-[160px]"
            >
              Create Account
            </Link>
          </div>
